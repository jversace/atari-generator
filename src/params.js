...
export const referenceModels = {
  ...
  adolescent: {
    head:   { width: 14.6, height: 20.2, depth: 14.9 },
    neck:   { height: 6.5, radius: 3.3 },
    thorax: { topWidth: 28, topDepth: 10.5, botWidth: 21.5, botDepth: 9, height: 24.6 },
    pelvis: { topWidth: 23, topDepth: 13, botWidth: 17.5, botDepth: 9.8, height: 10, wedgeHeight: 9 },
    spine:  { length: 9.5, curve1: 0, curve2: 1.3 },
    upperArm: { length: 26, radius: 2.3 },
    forearm:  { length: 21.5, radius: 1.95 },
    hand:     { length: 11.8, width: 5.4, thickness: 2.15 },
    thigh: { length: 39.5, radius: 3.75 },
    shin:  { length: 34.5, radius: 2.95 },
    foot:  { length: 21.5, width: 8, thickness: 3.65 },
    joints: { shoulder: 4.2, elbow: 3.1, wrist: 2.25, hip: 4.8, knee: 4.0, ankle: 2.7 },
  },
  adolescente: {
    head:   { width: 14, height: 19.3, depth: 14.2 },
    neck:   { height: 6.5, radius: 2.9 },
    thorax: { topWidth: 25, topDepth: 9.5, botWidth: 19.3, botDepth: 8.1, height: 23.7 },
    pelvis: { topWidth: 24.5, topDepth: 13.5, botWidth: 18.6, botDepth: 10.3, height: 10, wedgeHeight: 9.5 },
    spine:  { length: 9, curve1: 0, curve2: 1.3 },
    upperArm: { length: 23.5, radius: 1.95 },
    forearm:  { length: 19.5, radius: 1.65 },
    hand:     { length: 10.8, width: 4.9, thickness: 1.95 },
    thigh: { length: 40.5, radius: 3.3 },
    shin:  { length: 35.5, radius: 2.6 },
    foot:  { length: 20, width: 7.2, thickness: 3.3 },
    joints: { shoulder: 3.75, elbow: 2.7, wrist: 2.0, hip: 4.6, knee: 3.65, ankle: 2.45 },
  },
};
